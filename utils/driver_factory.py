...
class DriverFactory:
        ...
        if is_mobile:
            if device_name:
                ...
                mobile_emulation = {
                    ...
                    "userAgent": "Mozilla/5.0 (iPhone; CPU iPhone OS 15_0 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/15.0 Mobile/604.1"
                }
    ...
    def create_driver(browser_type: str = "chrome",
        ...
        if browser_type.lower() == "chrome":
            chrome_options = DriverFactory.get_chrome_options(
                is_mobile=is_mobile,
...
# Available mobile devices for emulation
MOBILE_DEVICES = {
    "iPhone_12_Pro": "iPhone 12 Pro",
    "iPhone_SE": "iPhone SE",
    "Pixel_5": "Pixel 5",
    "Galaxy_S20": "Samsung Galaxy S20 Ultra",
    "iPad_Mini": "iPad Mini"
}